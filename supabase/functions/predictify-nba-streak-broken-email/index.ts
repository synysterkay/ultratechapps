// Supabase Edge Function: predictify-nba-streak-broken-email
//
// Fires when a Predictify NBA user's prediction win-streak ends. A
// re-engagement nudge at the moment a user is most likely to churn.
//
//   POST .../functions/v1/predictify-nba-streak-broken-email
...
const TEMPLATES: Record<string, Template> = {
  en: {
    ...
    body: [
      "Hey {{first_name}},",
      "Your prediction streak just ended. It happens to everyone — even the model misses. What separates the sharp from the casual is showing up the next night anyway.",
      "Tonight's slate is live. Open the app, check the AI's picks, and start a new streak. The best run is always the one that starts right after a loss.",
...
const FOOTERS: Record<string, string> = {
  en: "You're receiving this because your prediction streak on Predictify NBA just ended.",
  es: "Recibes esto porque tu racha de predicciones en Predictify NBA acaba de terminar.",
  fr: "Vous recevez ceci car votre série de pronostics sur Predictify NBA vient de s'arrêter.",
  ar: "تتلقى هذا لأن سلسلة توقعاتك على Predictify NBA انتهت للتو.",
  pt: "Você recebe isto porque sua sequência de previsões no Predictify NBA acabou.",
  de: "Du erhältst dies, weil deine Vorhersage-Serie bei Predictify NBA gerade gerissen ist.",
  tr: "Bunu, Predictify NBA'deki tahmin serin az önce sona erdiği için alıyorsunuz.",
  it: "Ricevi questo perché la tua striscia di pronostici su Predictify NBA è appena finita.",
  nl: "Je ontvangt dit omdat je voorspellingsreeks op Predictify NBA zojuist is geëindigd.",
  pl: "Otrzymujesz to, bo Twoja seria prognoz w Predictify NBA właśnie się skończyła.",
  ja: "Predictify NBAでの連続的中が途切れたため、このメールをお送りしています。",
  hi: "आपको यह इसलिए मिल रहा है क्योंकि Predictify NBA पर आपकी भविष्यवाणी लय अभी टूटी।",
  id: "Kamu menerima ini karena rentetan prediksimu di Predictify NBA baru saja berakhir.",
};
