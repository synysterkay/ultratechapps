...
const SENDER_POOL = [
  ...
  { email: "hello@aifootballai.com",      name: "Morgan" },
  { email: "hello@aibetaipredictions.com", name: "Taylor" },
  { email: "hello@aibetaipredictify.com", name: "Riley" },
  { email: "hello@aifootballprediction.com", name: "Drew" },
];
