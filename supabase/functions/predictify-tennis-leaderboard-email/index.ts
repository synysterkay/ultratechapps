// Supabase Edge Function: predictify-tennis-leaderboard-email
//
// Fires INSTANTLY the first time a Predictify Tennis user breaks into the Top 10
...
//
//   POST .../functions/v1/predictify-tennis-leaderboard-email
...
const TEMPLATES: Record<string, Template> = {
  en: {
    ...
    body: [
      "Hey {{first_name}},",
      "It's official — you've cracked the Top 10 on the Predictify Tennis leaderboard. You're sitting at #{{rank}}, ahead of thousands of fans who thought they knew the game better than you.",
      "Here's the thing about the leaderboard: it never sleeps. Today's matches reshuffle everything, and the people right behind you are locking in their picks as you read this. Stay sharp, keep predicting, and defend your spot.",
  ...
  es: {
    ...
    body: [
      "Hola {{first_name}},",
      "Es oficial: entraste al Top 10 de la tabla de Predictify Tennis. Estás en el puesto #{{rank}}, por delante de miles de aficionados que creían conocer mejor el juego.",
  ...
  fr: {
    ...
    body: [
      "Bonjour {{first_name}},",
      "C'est officiel : tu es entré dans le Top 10 du classement Predictify Tennis. Tu es à la place #{{rank}}, devant des milliers de fans qui pensaient mieux connaître le jeu que toi.",
  ...
  ar: {
    ...
    body: [
      "مرحبًا {{first_name}}،",
      "الأمر رسمي — دخلت قائمة أفضل 10 في ترتيب Predictify Tennis. أنت في المركز #{{rank}}، متقدمًا على آلاف المشجعين الذين ظنوا أنهم يعرفون اللعبة أفضل منك.",
  ...
  pt: {
    ...
    body: [
      "Olá {{first_name}},",
      "É oficial — você entrou no Top 10 do ranking do Predictify Tennis. Está na posição #{{rank}}, à frente de milhares de fãs que achavam que entendiam mais do jogo que você.",
  ...
  de: {
    ...
    body: [
      "Hallo {{first_name}},",
      "Es ist offiziell — du hast es in die Top 10 der Predictify-Tennis-Rangliste geschafft. Du stehst auf Platz #{{rank}}, vor tausenden Fans, die dachten, sie kennen das Spiel besser als du.",
  ...
  tr: {
    ...
    body: [
      "Merhaba {{first_name}},",
      "Resmi oldu — Predictify Tennis sıralamasında ilk 10'a girdin. #{{rank}} sıradasın, oyunu senden iyi bildiğini sanan binlerce taraftarın önünde.",
  ...
  it: {
    ...
    body: [
      "Ciao {{first_name}},",
      "È ufficiale — sei entrato nella Top 10 della classifica di Predictify Tennis. Sei al #{{rank}}, davanti a migliaia di tifosi che credevano di conoscere il gioco meglio di te.",
  ...
  nl: {
    ...
    body: [
      "Hoi {{first_name}},",
      "Het is officieel — je bent doorgedrongen tot de Top 10 van de Predictify Tennis-ranglijst. Je staat op #{{rank}}, vóór duizenden fans die dachten dat ze het spel beter kenden dan jij.",
  ...
  pl: {
    ...
    body: [
      "Cześć {{first_name}},",
      "To oficjalne — wszedłeś do Top 10 rankingu Predictify Tennis. Jesteś na pozycji #{{rank}}, przed tysiącami kibiców, którzy myśleli, że znają grę lepiej niż Ty.",
  ...
  ja: {
    ...
    body: [
      "{{first_name}}さん、こんにちは。",
      "正式に決定 — Predictify Tennisのランキングでトップ10入りを果たしました。現在第{{rank}}位、自分の方が試合を知っていると思っていた何千ものファンの上にいます。",
  ...
  hi: {
    ...
    body: [
      "नमस्ते {{first_name}},",
      "यह आधिकारिक है — आप Predictify Tennis लीडरबोर्ड के टॉप 10 में पहुँच गए। आप #{{rank}} पर हैं, उन हज़ारों फैंस से आगे जो सोचते थे कि वे खेल आपसे बेहतर जानते हैं।",
  ...
  id: {
    ...
    body: [
      "Hai {{first_name}},",
      "Resmi — kamu masuk Top 10 papan peringkat Predictify Tennis. Kamu di posisi #{{rank}}, di depan ribuan penggemar yang mengira lebih paham permainan daripada kamu.",
...
const FOOTERS: Record<string, string> = {
  en: "You're receiving this because you just broke into the Top 10 on Predictify Tennis.",
  es: "Recibes esto porque acabas de entrar al Top 10 en Predictify Tennis.",
  fr: "Vous recevez ceci car vous venez d'entrer dans le Top 10 sur Predictify Tennis.",
  ar: "تتلقى هذا لأنك دخلت للتو قائمة أفضل 10 على Predictify Tennis.",
  pt: "Você recebe isto porque acabou de entrar no Top 10 no Predictify Tennis.",
  de: "Du erhältst dies, weil du gerade in die Top 10 bei Predictify Tennis gekommen bist.",
  tr: "Bunu, Predictify Tennis'de az önce ilk 10'a girdiğiniz için alıyorsunuz.",
  it: "Ricevi questo perché sei appena entrato nella Top 10 su Predictify Tennis.",
  nl: "Je ontvangt dit omdat je net de Top 10 op Predictify Tennis hebt bereikt.",
  pl: "Otrzymujesz to, bo właśnie wszedłeś do Top 10 w Predictify Tennis.",
  ja: "Predictify Tennisでトップ10入りしたため、このメールをお送りしています。",
  hi: "आपको यह इसलिए मिल रहा है क्योंकि आप अभी Predictify Tennis पर टॉप 10 में पहुँचे।",
  id: "Kamu menerima ini karena baru saja masuk Top 10 di Predictify Tennis.",
};
