// Supabase Edge Function: onbrief-quota-hit-email
// Instant upgrade nudge when Onbrief shows the writing paywall.
//
// Called by Flutter InstantEmailService when usage.freeChapterUsed flips:
//   POST https://jimcdgkwbbrxgakingtg.supabase.co/functions/v1/onbrief-quota-hit-email
//   Authorization: Bearer <SUPABASE_ANON_KEY>
// Dedup: instant_emails_sent (uid, event_kind='onbrief_quota_hit')
